...
# Основной список транзакций для тестирования базовых вариантов
@pytest.fixture
def test_list():
    test_list = [
        {
...
# Тестирование генератора card_number_generator на разные значения, максимум, минимум и
# и переходы через четвертые разряды.
